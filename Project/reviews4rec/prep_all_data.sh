...
py preprocess_random_split.py $dataset_name $data_file_path $k_core $perc_reviews $data_store_path
...
py make_quick_data.py $dataset_name $k_core $perc_reviews "NARRE" $quick_data_narre_path $data_store_path
