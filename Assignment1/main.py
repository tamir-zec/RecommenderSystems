...
if __name__ == '__main__':
    ...
    #                                sgd_step_size=sgd_step_size, rand_const=rand_const_basic,
    ...
    #                                  sgd_step_size=sgd_step_size, implicit_lrate=implicit_lr,
    #                                  rand_const=rand_const_advanced,
    #                                  latent_factors=latent_factors)
    #
    # recsys_svdpp.Load()
    # recsys_svdpp.initialize_data()
    # rmse_results_val_pp, mae_results_val_pp, rmse_results_train_pp, mae_results_train_pp, n_pp = recsys_svd.TrainAdvancedModel(
    #     n_iter)
    #
    ...
    # val_save_result_path = os.path.join('results', 'basic_model_results_val.csv')
    #
    # trainAdv_save_result_path = os.path.join('results', 'advanced_model_results_train.csv')
    # valAdv_save_result_path = os.path.join('results', 'advanced_model_results_val.csv')
    #
